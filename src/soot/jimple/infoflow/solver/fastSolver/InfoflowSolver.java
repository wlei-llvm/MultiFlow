...
public class InfoflowSolver extends IFDSSolver<Unit, Abstraction, SootMethod, BiDiInterproceduralCFG<Unit, SootMethod>>
	...
	protected final Set<Abstraction> endAbsSet =
	...
	@Override
	protected void storeEndAbs(Abstraction end ,Abstraction neigh) {
		this.endAbsSet.add(end);
		this.endAbsSet.add(neigh);

		return ;
	}

	public Set<Abstraction> getEndAbs() {
		return this.endAbsSet;
	}
