...
public class InfoflowConfiguration {
	...
	public enum MultiTaintMode {
		SoloModeForTest,
		CustomALL,
		Custom,
		DoubleCombination,
		AllCombination,
		AllCombinationForTest,
		AllCombCallBackPartition
	...
	//Multi-Tag
	private boolean multiTaintAnalysisEnable = true;
	private boolean multiCallBackEnd = true;

	private boolean dumpSourceEnable = false;
	//private  MultiTaintMode multiTaintMode = MultiTaintMode.SoloModeForTest;
//	private  MultiTaintMode multiTaintMode = MultiTaintMode.Custom;
//	private  MultiTaintMode multiTaintMode = MultiTaintMode.AllCombination;
	private  MultiTaintMode multiTaintMode = MultiTaintMode.AllCombCallBackPartition;
	...
	public boolean getMultiTaintAnalysisEnable() {
		return multiTaintAnalysisEnable;
	}

	public void setMultiTaintAnalysisEnable(boolean multiTaintAnalysisEnable) {
		this.multiTaintAnalysisEnable = multiTaintAnalysisEnable;
	}

	public boolean isDumpSourceEnable() {
		return dumpSourceEnable;
	}

	public void setDumpSourceEnable(boolean dumpSourceEnable) {
		this.dumpSourceEnable = dumpSourceEnable;
	}

	public MultiTaintMode getMultiTaintMode() {
		return multiTaintMode;
	}

	public void setMultiTaintMode(MultiTaintMode multiTaintMode) {
		this.multiTaintMode = multiTaintMode;
	}

	public boolean isEnableCallBackEnd() {
		return multiCallBackEnd;
	}

	public void setEnableCallBackEnd(boolean multiCallBackEnd) {
		this.multiCallBackEnd = multiCallBackEnd;
	}
