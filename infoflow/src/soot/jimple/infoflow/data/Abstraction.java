...
public class Abstraction implements Cloneable, FastSolverLinkedNode<Abstraction, Unit>,
	...
	private Pair<Triplet<Unit, Unit, Abstraction>, Abstraction> summaryPredecessor = null;

	private Set<Abstraction> neighbors = null;
	private Stmt currentStmt = null;
	private Stmt correspondingCallSite = null;

	private Pair<Unit, SootMethod> calleeInfo = null;

	private Set<Triplet<Unit, Unit, Abstraction>> returnSiteSet = null;

	private Abstraction endAbstraction = null;
	private Stmt endSinkStmt = null;

	private Unit aliasStmt = null;


	private Map<Stmt, Set<Abstraction>> normalFlowMap = null;
	private Map<Pair<Unit, Unit>, Set<Abstraction>> returnFlowMap = null;
	private Map<Pair<Unit, SootMethod>, Set<Abstraction>> callFlowMap = null;
	private Map<Unit, Set<Pair<Unit, Abstraction>>> summaryFlowMap = null;

	private Map<Unit, Set<Abstraction>> aliasFlowMap = null;
	...
	public Abstraction(AccessPath apToTaint,
	...
	protected Abstraction(AccessPath p, Abstraction original){
		if (original == null) {
			...
			//Multi-TAG
			normalFlowMap = original.normalFlowMap;
			callFlowMap = original.callFlowMap;
			returnFlowMap = original.returnFlowMap;
			aliasFlowMap = original.aliasFlowMap;
			summaryFlowMap = original.summaryFlowMap;
			aliasFlowMap = original.aliasFlowMap;
	...
	public Abstraction clone() {
		...
		//Multi-Tag
		if(AbstractionVector.isEndAbstraction(this)) {
			abs.endAbstraction = this.endAbstraction;
			abs.endSinkStmt = this.endSinkStmt;
		}
	...
	public boolean equals(Object obj) {
		...
		//Multi-Tag
		if(AbstractionVector.isEndAbstraction(this)) {
			if (endAbstraction == null) {
				if (other.endAbstraction != null)
					return false;
			} else if (!endAbstraction.equals(other.endAbstraction))
				return false;
			if (endSinkStmt == null) {
				if (other.endSinkStmt != null)
					return false;
			} else if (!endSinkStmt.equals(other.endSinkStmt))
				return false;
		}
	...
	public Abstraction getEndAbstraction() {
		return this.endAbstraction;
	}
	public Stmt getEndSinkStmt() {
		return this.endSinkStmt;
	}

	public void setEndAbstraction(Abstraction endAbstraction) {
		this.endAbstraction = endAbstraction;
	}

	public void setEndSinkStmt(Stmt endSinkStmt) {
		this.endSinkStmt = endSinkStmt;
	}

	public Unit getAliasStmt() {
		return aliasStmt;
	}

	public void setAliasStmt(Unit aliasStmt) {
		this.aliasStmt = aliasStmt;
	}
	...
	@Override
	public void setSummaryPredecessor(Pair<Triplet<Unit, Unit, Abstraction>, Abstraction> summaryPredecessor) {
		this.summaryPredecessor = summaryPredecessor;
	}

	@Override
	public Pair<Triplet<Unit, Unit, Abstraction>, Abstraction> getSummaryPredecessor() {
		return this.summaryPredecessor;
	}
	...
	public Pair<Unit, SootMethod> getCalleeInfo() {
		return calleeInfo;
	}

	public void setCalleeInfo(Pair<Unit, SootMethod> calleeInfo) {
		this.calleeInfo = calleeInfo;
	}
	public Set<Triplet<Unit, Unit, Abstraction>> getReturnSiteInfo() {
		return returnSiteSet;
	}

	public void addReturnSiteInfo(Triplet<Unit, Unit, Abstraction> returnSiteInfo) {
		if(returnSiteSet == null)
			returnSiteSet = new ConcurrentHashSet<Triplet<Unit, Unit, Abstraction>>();

		returnSiteSet.add(returnSiteInfo);

	}



	public Map<Stmt, Set<Abstraction>> getNormalFlowMap() {
		return normalFlowMap;
	}

	public void setNormalFlowMap(Map<Stmt, Set<Abstraction>> normalFlowMap) {
		this.normalFlowMap = normalFlowMap;
	}

	public Map<Pair<Unit, Unit>, Set<Abstraction>> getReturnFlowMap() {
		return returnFlowMap;
	}

	public void setReturnFlowMap(Map<Pair<Unit, Unit>, Set<Abstraction>> returnFlowMap) {
		this.returnFlowMap = returnFlowMap;
	}

	public Map<Pair<Unit, SootMethod>, Set<Abstraction>> getCallFlowMap() {
		return callFlowMap;
	}

	public void setCallFlowMap(Map<Pair<Unit, SootMethod>, Set<Abstraction>> callFlowMap) {
		this.callFlowMap = callFlowMap;
	}

	public Map<Unit, Set<Pair<Unit, Abstraction>>> getSummaryFlowMap() {
		return summaryFlowMap;
	}

	public void setSummaryFlowMap(Map<Unit, Set<Pair<Unit, Abstraction>>> summaryFlowMap) {
		this.summaryFlowMap = summaryFlowMap;
	}



	public Map<Unit, Set<Abstraction>> getAliasFlowMap() {
		return aliasFlowMap;
	}

	public void setAliasFlowMap(Map<Unit, Set<Abstraction>> aliasFlowMap) {
		this.aliasFlowMap = aliasFlowMap;
	}
